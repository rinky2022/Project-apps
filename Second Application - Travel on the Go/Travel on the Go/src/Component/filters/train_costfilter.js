...
import trainListing from '../Listing/train_listing';


const url = "https://travelgo-api.herokuapp.com/filter_cost";

class train_costfilter extends Component {
    ...
    filterCost = (event) => {
        ...
        axios.get(costUrl)
        .then((res) => {this.props.traincostfilters(res.data)})
        ...
        return(
            ...
            <br/>
                ...
                <div style={{marginLeft:'15%'}} onChange={this.filterCost}>
                    ...
                    <label className="radio">
                        <input type="radio" value="7001-15000" name="cuisine"/>7001-15000
                    </label>
                </div>
            </>
        )
...
export default train_costfilter