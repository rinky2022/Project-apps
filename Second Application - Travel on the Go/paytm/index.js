...
if(!paymentDetails.amount || !paymentDetails.customerId || !paymentDetails.customerEmail || !paymentDetails.customerPhone || !paymentDetails.customerRest) {
    ...
    params['CALLBACK_URL'] = 'https://pay-tm1.herokuapp.com/callback';
     ...
     checksum_lib.genchecksum(params, config.PaytmConfig.key, function (err, checksum) {
       ...
       var post_req = https.request(options, function(post_res) {
         ...
         post_res.on('end', function(){
           ...
           res.redirect(`https://travel-on-th-go-app.herokuapp.com/viewBooking?status=${_results.STATUS}&ORDERID=${_results.ORDERID}&date=${_results.TXNDATE}&bank=${_results.BANKNAME}`)
           });
       });
